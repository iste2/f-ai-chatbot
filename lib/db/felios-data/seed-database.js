...
for (const opId of allOperationIds) {
  ...
  // Pick all employees qualified for the resource
  ...
  // Try to assign as many employees as possible who have enough shift capacity for all days
  const assignedEmployees = [];
  for (let tryIdx = 0; tryIdx < qualified.length; tryIdx++) {
