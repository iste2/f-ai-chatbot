...
db.prepare('INSERT INTO resource_assignment (resource_id, employee_id, date, assigned_capacity) VALUES (?, ?, ?, ?)').run(resourceId, employeeId, '2025-06-10', 8);
// Insert example for employee_shift
// Assign Alice to the Morning shift on 2025-06-10
