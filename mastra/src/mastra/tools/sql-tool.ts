...
- name: Project name.
- color_code: Project color code (hex string).
...
- start_date: Operation start date (YYYY-MM-DD).
- end_date: Operation end date (YYYY-MM-DD).
...
- color_code: Color code for the shift (hex string).
